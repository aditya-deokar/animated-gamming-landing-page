        ...
        <div className="relative size-full ">
            ...
            <div className="relative z-10 flex size-full flex-col justify-between p-4 ">
                <div>
                    ...
                    {
                        description && ( <p className="mt-3 max-w-64 text-base">{description}</p> )
                    }
                </div>
            </div>
  ...
  return (
    <section className='bg-black pb-52 text-blue-50'>
        <div className='container mx-auto px-3 md:px-10 '>
            ...
            <p className='max-w-md font-circular-web text-blue-50 text-lg opacity-50'>Lorem m dolor sit amet consectetur adipisicing elit. Laborum nesciunt deserunt, voluptate adipisci ipsua ut animi natus quae excepturi illum?</p>
            ...
            <BentoTilt className='border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]'>
                    ...
                    description="Lorem m dolor sit amet consectetur adipisicing elit. Laborum nesciunt deserunt, voluptate adipisci ipsua"
